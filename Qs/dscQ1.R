...
q1q1 <- file.info("final/en_US/en_US.blogs.txt")
MB <- (q1q1$size)/1000000

## Q2

q1q2Input <- file("final/en_US/en_US.twitter.txt", "r")
...
q1q4Input <- "final/en_US/en_US.twitter.txt"
...
q1q5Input <- "final/en_US/en_US.twitter.txt"
